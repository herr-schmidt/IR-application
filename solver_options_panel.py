...
from PySide6.QtWidgets import (QApplication, QFrame, QGridLayout, QLabel,
    QLineEdit, QSizePolicy, QSlider, QWidget)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_11.setText(QCoreApplication.translate("Form", u"Gap relativo", None))
        self.lineEdit_11.setText(QCoreApplication.translate("Form", u"0.0", None))
        self.lineEdit_11.setPlaceholderText("")
        self.lineEdit_9.setText(QCoreApplication.translate("Form", u"0.0", None))
        self.lineEdit_9.setPlaceholderText("")
        self.label_7.setText(QCoreApplication.translate("Form", u"Robustezza", None))
        self.label_6.setText(QCoreApplication.translate("Form", u"Impostazioni solver", None))
        self.lineEdit_7.setText(QCoreApplication.translate("Form", u"0.0", None))
        self.lineEdit_7.setPlaceholderText("")
        self.label_8.setText(QCoreApplication.translate("Form", u"Giornata operatoria", None))
        self.label_10.setText(QCoreApplication.translate("Form", u"Disponibilit\u00e0 anestesisti", None))
        self.lineEdit_10.setText(QCoreApplication.translate("Form", u"0.0", None))
        self.lineEdit_10.setPlaceholderText("")
        self.label_9.setText(QCoreApplication.translate("Form", u"Anestesisti", None))
        self.lineEdit_8.setText(QCoreApplication.translate("Form", u"0.0", None))
        self.lineEdit_8.setPlaceholderText("")
        self.label_12.setText(QCoreApplication.translate("Form", u"Tempo limite", None))
        self.lineEdit_12.setText(QCoreApplication.translate("Form", u"0.0", None))
